...
2. **Fix Splash Screen Background Configuration**:
   ...
   - **Step 2.1**: Check `android/app/src/main/res/values/styles.xml` (and `values-night/styles.xml` if it exists).
   ...
   - **Step 2.2**: Create or update `android/app/src/main/res/drawable/splash_background.xml` to compose the background color and the centered splash image.
